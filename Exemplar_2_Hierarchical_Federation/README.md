...
For a video illustration of the implementation and execution of Exemplar 2, refer to minute 03:24 of the following video: https://youtu.be/Hy_iY0UnPJA
...
```bash
cd Exemplar_2_Hierarchical_Federation
```
...
The exemplar starts 17 services in total. The main long-running containers are:
