...
For a video illustration of the implementation and execution of Exemplar 1, refer to minute 00:06 of the following video: [https://youtu.be/Hy_iY0UnPJA](https://youtu.be/Hy_iY0UnPJA)
...
<img width="310" height="300" alt="centralized (1)" src="https://github.com/user-attachments/assets/262fc16c-c6cf-48ce-9a14-a6e6ccfab4a1" />
...
From the root of the repository, enter the folder of this exemplar:

```bash
cd Exemplar_1_Centralized_Federation
```
...
The exemplar starts 18 services in total. Most containers should remain running, while the three initialization containers are one-shot services that create the required DT structures and then finish.
